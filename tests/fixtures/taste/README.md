...
- `claude-cli/projects/-Users-fixture-Workspace-jottrace/00000000-0000-4000-8000-000000000031.jsonl`
  ...
  subagent `Edit` (with sidecar snapshot), `Bash` file edits, `NotebookEdit`, MCP file edit, a partial-accept edit pair, a manual IDE edit snapshot (R4), a permission denial, a revert,
  and timeline bumps.
